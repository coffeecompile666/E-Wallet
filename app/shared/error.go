...
var (
	...
	ErrJournalEntryMustHaveTwo            = Error{1037, 401, "journal entry must have two ledger entries"}
	ErrJournalEntryInvalid                = Error{1038, 401, "journal entry invalid"}
	ErrJournalEntryDebitCreditMustBeEqual = Error{1039, 401, "journal entry debit and credit must be equal"}
	ErrLedgerAccountNotFound              = Error{1040, 401, "ledger account not found"}
	ErrSystemAccountNotFound              = Error{1041, 401, "system account not found"}
)
